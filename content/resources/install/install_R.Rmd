...
title: "Install R"
date: '`r Sys.Date()`'
summary: 'Walkthrough of how to install R'
featured: true
draft: false
output:
  html_document:
...
2. Click on "Download R for `XXX`", where `XXX` is either Mac or Windows:
   ...
   include_graphics("install-r-links.png", error = FALSE)
   ```
   ...
   - If you use macOS, scroll down to the first `.pkg` file in the list of files (in this picture, it's `R-4.0.0.pkg`; as of right now, the current version is **4.2.1**) and download it.
     ...
     include_graphics("install-r-mac.png", error = FALSE)
     ```
    
   - If you use Windows, click "base" (or click on the bolded "install R for the first time" link) and download it. 
    
     ```{r, echo=FALSE, out.width="100%", fig.align="center"}
     include_graphics("install-r-windows.png", error = FALSE)
     ```
...
2. The website should automatically detect your operating system (macOS or Windows) and show a big download button for it:
   ...
   include_graphics("install-r-rstudio1.png", error = FALSE)
   ```
    
   If not, scroll down a little to the large table and choose the version of RStudio that matches your operating system.

   ```{r, echo=FALSE, out.width="100%", fig.align="center"}
   include_graphics("install-r-rstudio2.png", error = FALSE)
   ```
...
include_graphics("install-r-package-panel.png", error = FALSE)
```
...
- Go to the packages panel in RStudio, click on "Install," type "tidyverse", and press enter. You'll see a bunch of output in the RStudio console as all the tidyverse packages are installed.
  ...
  ```{r, echo=FALSE, out.width="60%", fig.align="center"}
  include_graphics("install-r-tidyverse.png", error = FALSE)
  ```
