...
## Leading discussion with class guests (10%)

Once during the semester you (possibly in a pair) will be
responsible for leading discussions with that week’s class guest. Your job will be easier if everyone jumps in and asks questions, but if the discussion is lagging, you’ll jump in with some prepared questions for the speaker.
