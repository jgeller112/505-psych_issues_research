...
batman_data <- data.frame(
  ...
  end = as.character(c("2012-05-06","2017-08-08", "2019-01-04", "2020-01-07", "2020-01-08", "2023-01-07"))
) 
...
- By appointment
  ...
  - Microsoft Bookings:
  **https://outlook.office365.com/owa/calendar/Fall2022@princeton.edu/bookings/**
...
During the semester you (possibly in a pair) will be
